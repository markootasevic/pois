    ...
    <body>
        <form role='form' action='{{url('/inicijativa')}}' method='post' enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" style="width: 600px;" class="form-control" name="nazivProcedure" placeholder="npr: Produženje registracije" required>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea style="resize:both; width: 600px;" class="form-control" id="primedbe" placeholder="Unesite primedbe koje imate na proceduru"></textarea>
                </div>
