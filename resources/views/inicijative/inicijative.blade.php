<html5>
    ...
    resize: none;' required>
            ...
            <div class="form-group">
                ...
                <input type="textarea" rows="4" cols="50"  class="form-control" id="predlog" 
                placeholder="Navedite na koji način biste želeli da promenite proceduru" style='
            overflow-y: scroll;
            max-height: 100px;
            resize: none;' required>
            </div>
